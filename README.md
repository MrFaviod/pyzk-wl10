...
zk = ZK('192.168.180.201', timeout=20, ommit_ping=True, force_udp=False,
        wl10=True)
zk.connect()
...
```
$ python3 listar_marcaciones.py 192.168.180.201 --since 2026-07-01
   Badge | Nombre                         | Fecha/Hora             | Status | Punch
--------------------------------------------------------------------------------
     138 | Rivarola Enciso, Juan A        | 2026-07-01 14:05:38    | 1      | 0
     209 | Rolon, Gladys                  | 2026-07-01 15:24:53    | 1      | 0
     134 | Gonzalez Espinoza, Mari        | 2026-07-01 15:26:32    | 1      | 0
     ...
```
