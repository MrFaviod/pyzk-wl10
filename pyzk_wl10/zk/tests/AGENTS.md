...
Scope: conventions for the 91-test offline suite. Repo context:
`../../../AGENTS.md`. Library API: `../AGENTS.md`.

## Run

```bash
python3 -m pytest pyzk_wl10/zk/tests/ -q     # 91 passed, offline, no hardware
```
...
| test_socket_mss.py | 4 | TCP MSS / chunking |
| test_wl10_raw_drain.py | 2 | raw socket drain / framing |
| test_wl10_resilience.py | 19 | dedup, missing-user, truncated reads |
